...
import axios from '@/api/axios'; // Updated import path using '@' alias
import auth from './modules/auth';
import form from './modules/form';
import newApplication from './modules/newApplication';
import resetPassword from './modules/resetPassword';
import customerPage from '@/store/modules/customerPage'; // Updated to use alias '@'
import contractsAndPayments from './modules/contractsAndPayments';
import userProfile from '@/store/modules/userProfile'; // Updated to use alias '@'
import specSeachPage from '@/store/modules/Provider/specSeachPage'; // Updated to use alias '@'
import applicationPageSpec from '@/store/modules/Provider/applicationPageSpec'; // Updated to use alias '@'
import authProvider from '@/store/modules/Provider/authProvider'; // Updated to use alias '@'

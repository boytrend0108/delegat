export default {
  ...
  mutations: {
    ...
    SET_RESET_FORM_STATUS(state) {
      // cбрасывает настройки до начальных
    ...
    SET_VALIDATION_ERR(state, err) {
      state.validationErrors = "Api does't work. Sorry..."; //Заглушка
      return;

      // if (err === 'clear') {
      //   state.validationErrors = '';
      //   return;
      // } else if (err === 'Incorrect user password')
      //   state.validationErrors = 'Неверный пароль';
      // else if (err.includes('already exists') && err.includes('email'))
      //   state.validationErrors =
      //     'Пользователь с таким email уже зарегистрирован';
      // else if (err.includes('already exists') && err.includes('phone_number'))
      //   state.validationErrors =
      //     'Пользователь с таким телефоном уже зарегистрирован';
      // else if (err.includes('not found'))
      //   state.validationErrors = 'Пользователь с таким email не найден';
      // else if (err.includes('Offer already exist'))
      //   state.validationErrors = 'Вы уже откликались на эту заявку';
      // else if (err.includes('The user is not authorized'))
      //   state.validationErrors = 'Пользователь не авторизован в системе';
      // else if (err.includes('value is not a valid email address'))
      //   state.validationErrors = 'Не верно указан Email пользователя';
